...
if (isset($_POST['plaintes'])) {
    ...
    $date_heure_lieu = htmlspecialchars(trim(strip_tags($_POST['date_heure_lieu'])));
                                                                ...
                                                                if (!empty($_POST['id_thematique'])) {
                                                                    if (!empty($_POST['name_agent'])) {
                                                                        if (!empty($_POST['lieu_sssu'])) {
                                                                            if (!empty($_POST['date_heure_lieu'])) 
                                                                            {
                                                                                if (!empty($_POST['desc_plainte'])) {
                                                                                    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                                                                        ...
                                                                                        if ($nombre == 10) 
                                                                                        {
                                                                                            ...
                                                                                            {
                                                                                                addPlainte($anony, $auth_data, $fullname, $phone, $email, $habitation, $id_pays, $id_region, $id_ville, $id_commune, $id_age, $id_statut_pro, $id_nscolaire, $etab_scolaire, $id_classe, $id_thematique, $name_agent, $lieu_sssu, $date_heure_lieu, $desc_plainte, $confirmation);
                                                                                            } else {
                                                                                                $erreur[] =
                                                                                                    "
                                                                                                    <div class='card-body'>
                                                                                                        <div class='alert alert-danger alert-dismissible fade show' role='alert'>
                                                                                                            ...
                                                                                                            le champ de confirmation de donnée  est vide
                                                                                ...
                                                                                $erreur[] =
                                                                                    "
                                                                                                <div class='card-body'>
                                                                                                    <div class='alert alert-danger alert-dismissible fade show' role='alert'>
                                                                                                        <strong>Erreur !</strong>
                                                                                                        le champ date et heure est vide
                                                                                                        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ";
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-group" method="POST">
                            <div class="row">
                                ...
                                <spam class="">
                                    <h6>Informations sur la plainte ==========</h6>
                                </spam>
                                <br /><br /><br />
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Date et heure à laquelle l'abus a eu lieu</label>
                                        <input type="datetime-local" class="form-control" name="date_heure_lieu" value="<?= $_POST['date_heure_lieu'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-sm-6 col-12">
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" require type="radio" name="confirmation" id="confirme" value="Je confirme">
